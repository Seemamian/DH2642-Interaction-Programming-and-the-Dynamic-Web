  ...
  open(onMessage, onDisconnect2) {
    ...
    try {
      ...
      if (isNodeSdk()) {
        ...
        options = {
          headers: {
            "User-Agent": `Firebase/${PROTOCOL_VERSION}/${SDK_VERSION2}/${import_process.default.platform}/${device}`,
        ...
        const env = import_process.default["env"];
...
function repoManagerDatabaseFromApp(app, authProvider, appCheckProvider, url, nodeAdmin) {
  ...
  if (typeof import_process.default !== "undefined" && import_process.default.env) {
    dbEmulatorHost = import_process.default.env[FIREBASE_DATABASE_EMULATOR_HOST_VAR];
  }
  if (dbEmulatorHost) {
    isEmulator = true;
