import {
  require_client
} from "./chunk-E2SNA6W6.js";
import {
  require_react_dom
} from "./chunk-Q7GLWBRO.js";
import {
  buildQueries,
  configure,
  createEvent,
...
} from "./chunk-NCCBJGTU.js";
import "./chunk-T33LG35T.js";
import {
  require_react
} from "./chunk-KRV7DR32.js";
import {
  __commonJS,
  __toESM,
  _global,
      ...
      return function(b, c) {
        ...
        l.unstable_batchedUpdates(function() {
          ...
          if (e) {
            ...
            if (L(a2))
              for (var d2 = 0; d2 < a2.length && !e.isPropagationStopped(); d2++)
                W(e, a2[d2], c2[d2]);
            else
              a2 && W(e, a2, c2);
...
var require_test_utils = __commonJS({
  "node_modules/react-dom/test-utils.js"(exports, module) {
    ...
    init_shim();
    if (import_process.default.env.NODE_ENV === "production") {
      module.exports = require_react_dom_test_utils_production_min();
    } else {
...
var _process$env;
if (typeof import_process.default === "undefined" || !((_process$env = import_process.default.env) != null && _process$env.RTL_SKIP_AUTO_CLEANUP)) {
