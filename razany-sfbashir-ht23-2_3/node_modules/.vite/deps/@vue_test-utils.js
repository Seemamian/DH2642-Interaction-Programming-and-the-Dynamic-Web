...
} from "./chunk-T4TEQBQW.js";
import {
  compile
} from "./chunk-NTOEGHUA.js";
import {
  BaseTransition,
  Comment,
  Fragment,
...
Symbol(!!(import_process.default.env.NODE_ENV !== "production") ? "iterate" : "");
Symbol(!!(import_process.default.env.NODE_ENV !== "production") ? "Map key iterate" : "");
...
function createStubComponentsTransformer(_a) {
  ...
  return function componentsTransformer(type, instance) {
    var _a2, _b2, _c2;
    if (isTeleport(type) && ("teleport" in stubs2 || "Teleport" in stubs2)) {
      if ("teleport" in stubs2 && stubs2["teleport"] === false)
        return type;
      if ("Teleport" in stubs2 && stubs2["Teleport"] === false)
        return type;
      return createStub({
    ...
    if ((type === Transition || type === BaseTransition) && ("transition" in stubs2 || "Transition" in stubs2)) {
      if ("transition" in stubs2 && stubs2["transition"] === false)
        return type;
      if ("Transition" in stubs2 && stubs2["Transition"] === false)
        return type;
      return createStub({
    ...
    if (type === TransitionGroup && ("transition-group" in stubs2 || "TransitionGroup" in stubs2)) {
      if ("transition-group" in stubs2 && stubs2["transition-group"] === false)
        return type;
      if ("TransitionGroup" in stubs2 && stubs2["TransitionGroup"] === false)
        return type;
      return createStub({
...
function createInstance(inputComponent, options2) {
  ...
  var global = mergeGlobalProperties(options2 === null || options2 === void 0 ? void 0 : options2.global);
    ...
    var mixin = {
      beforeCreate: function() {
        if (isScriptSetup(this)) {
          for (var _i2 = 0, _a2 = Object.entries(global.mocks); _i2 < _a2.length; _i2++) {
          ...
          this.$.proxy = new Proxy(this.$.proxy, {
            get: function(target, key2) {
              if (key2 in global.mocks) {
                return global.mocks[key2];
              }
              return target[key2];
            }
          });
        } else {
          for (var _c2 = 0, _d2 = Object.entries(global.mocks); _c2 < _d2.length; _c2++) {
  ...
  if (global.config) {
    for (var _i = 0, _a = Object.entries(global.config); _i < _a.length; _i++) {
      var _b = _a[_i], k = _b[0], v = _b[1];
      app.config[k] = isObject2(app.config[k]) ? Object.assign(app.config[k], v) : v;
    }
  }
  if (global.plugins) {
...
@vue/test-utils/dist/vue-test-utils.esm-bundler.mjs:
   ...
   *)
*/
//# sourceMappingURL=@vue_test-utils.js.map
