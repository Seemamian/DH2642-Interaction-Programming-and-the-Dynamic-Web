  ...
  "node_modules/es-get-iterator/index.js"(exports, module2) {
    ...
    if (require_has_symbols()() || require_shams()()) {
      ...
      if (!$Map && !$Set) {
        ...
        if (typeof import_process.default === "undefined" || !import_process.default.versions || !import_process.default.versions.node) {
...
var shouldHighlight = () => {
  ...
  try {
    ...
    colors = JSON.parse((_process = import_process.default) == null ? void 0 : (_process$env = _process.env) == null ? void 0 : _process$env.COLORS);
  } catch (e) {
  }
  if (typeof colors === "boolean") {
    return colors;
  } else {
    return typeof import_process.default !== "undefined" && import_process.default.versions !== void 0 && import_process.default.versions.node !== void 0;
  }
};
var {
  DOMCollection
...
function prettyDOM(dom, maxLength, options) {
  ...
  if (typeof maxLength !== "number") {
    maxLength = typeof import_process.default !== "undefined" && import_process.default.env.DEBUG_PRINT_LIMIT || 7e3;
  }
  if (maxLength === 0) {
    return "";
  }
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NCCBJGTU.js.map
