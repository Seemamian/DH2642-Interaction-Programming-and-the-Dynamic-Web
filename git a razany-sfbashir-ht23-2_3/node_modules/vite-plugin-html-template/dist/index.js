  ...
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      function get(object, path2, defaultValue) {
        var result2 = object == null ? undefined : baseGet(object, path2);
      ...
      function result(object, path2, defaultValue) {
        ...
        while (++index < length) {
          var value = object == null ? undefined : object[toKey(path2[index])];
          if (value === undefined) {
            index = length;
            value = defaultValue;
          }
      ...
      function propertyOf(object) {
        return function(path2) {
          return object == null ? undefined : baseGet(object, path2);
        };
      }
...
async function readHtmlTemplate(templatePath) {
  return await _fs.promises.readFile(templatePath, {encoding: "utf8"});
}
async function getHtmlTemplate(templatePath, entryJsPath) {
  const htmlContent = await readHtmlTemplate(templatePath);
  return htmlContent.replace('<div id="app"></div>', `<div id="app"></div>
...
// package.json
var name = "vite-plugin-html-template";

// src/index.ts
var resolve = (p) => _path2.default.resolve(process.cwd(), p);
  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use(async (req, res, next) => {
        if (!_optionalChain([req, 'access', _2 => _2.url, 'optionalAccess', _3 => _3.endsWith, 'call', _4 => _4(".html")]) && req.url !== "/") {
          return next();
        }
        let url = req.url;
        ...
        const entryJsPath = (() => {
          if (url === "/") {
            ...
            if (options.mpa) {
              return _optionalChain([url, 'optionalAccess', _5 => _5.replace, 'call', _6 => _6("./", "/"), 'access', _7 => _7.replace, 'call', _8 => _8(/(.*)\/(.*).html/, "$1/main")]);
            } else {
              return "/src/pages/index/main";
            }
          }
